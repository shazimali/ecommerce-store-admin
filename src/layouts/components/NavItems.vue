...
<template>
  <VerticalNavLink
    v-show="canUserAccess('dashboard_access')"
    :item="{
      title: 'Dashboard',
      icon: 'bx-home-smile',
      to: '/dashboard',
  ...
  />
  <VerticalNavLink
  v-show="canUserAccess('subcategory_access')"
    :item="{
  ...
  />
  <VerticalNavLink
   v-show="canUserAccess('coupon_access')"
    :item="{
      title: 'Coupons',
      icon: 'bx bxs-coupon',
      to: '/coupons'
  ...
  />
  <VerticalNavLink
  v-show="canUserAccess('user_access')"
    :item="{
      title: 'Users',
      icon: 'bx-user',
      to: '/users',
  ...
  />
  <VerticalNavLink
   v-show="canUserAccess('role_access')"
    :item="{
      title: 'Roles',
  ...
  />
  <VerticalNavLink
   v-show="canUserAccess('permission_access')"
    :item="{
      title: 'Permissions',
      icon: 'bx-dice-5',
      to: '/permissions'
